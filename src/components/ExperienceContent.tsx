...
export default function ExperienceContent() {
  ...
  const experiences: ExperienceItem[] = [
    {
      company: "Synauris",
      position: "Fullstack Web Developer & Project Lead",
      duration: "April 2025 – August 2025",
description: "Led full-stack development and product engineering at Synauris, building scalable web applications and designing user-centric interfaces. Owned system architecture, feature development, and deployment workflows with a focus on performance and maintainability.",

achievements: [
  "Designed and developed end-to-end web applications using modern frontend and backend technologies.",
  "Built and maintained responsive UI components with strong emphasis on usability, accessibility, and design consistency.",
  "Architected backend systems including API design, database schema, and server-side logic.",
  "Led development lifecycle: requirement analysis, system design, implementation, testing, and deployment.",
  "Optimized application performance and improved load times through efficient state and data handling.",
],
      href: "https://synauris.com",
      logoUrl: "/synauris.png",
    },
  ]
